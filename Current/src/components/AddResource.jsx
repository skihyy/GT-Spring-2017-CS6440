          ...
          <div style={styles.row}>
            ...
            <div>
                       <SelectField
                         ...
                         <MenuItem value={3} primaryText="General Medical" />
                         <MenuItem value={4} primaryText="Women" />
                         <MenuItem value={5} primaryText="Children" />
                         <MenuItem value={6} primaryText="Mental Health" />
